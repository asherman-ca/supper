	...
	return (
		<main className='flex-1 flex justify-center items-center p-4 gap-8 relative'>
			<div className='absolute top-0 right-0 -z-10 opacity-25'>
				<Image src={dashboardpreviewcrop} alt='dashboard preview' />
			</div>
			<div className='flex flex-col  gap-4 mt-4 bg-white dark:bg-[#1D232A] p-8 border-2 border-gray-200 max-w-[680px] rounded-md shadow-md'>
